	...
	function SlickGrid(container, data, columns, options) {
		...
		function createColumnHeaders() {
			...
			for (var i = 0; i < columns.length; i++) {
				...
				if (m.hasOwnProperty('showAsHTMLObject') && m.showAsHTMLObject) {
					...
					var header = $("<div class='ui-state-default slick-header-column' />")
						...
						.html("<span class='slick-column-name'>" + $("<a>").text(m.name).html() + "</span>")
		...
		function appendCellHtml(stringArray, row, cell, colspan, item) {
			...
			var cellCss = "slick-cell slick-cell-index_" + row + "_" + cell + " l" + cell + " r" + Math.min(columns.length - 1, cell + colspan - 1) +
